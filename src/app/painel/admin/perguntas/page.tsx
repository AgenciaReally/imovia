...
import { ConfiguracaoRegrasNegocio } from "@/components/admin/ConfiguracaoRegrasNegocio"
...
export default function PerguntasPage() {
  ...
  return (
    <DashboardLayout userRole="admin">
      ...
      {/* Modal de Regras de Negócio */}
      <Dialog open={regrasModalOpen} onOpenChange={setRegrasModalOpen}>
        <DialogContent className="sm:max-w-[900px] max-h-[90vh]">
          <DialogHeader>
            ...
            <DialogDescription>
              Configure regras para controle dinâmico do formulário e aprovação de financiamentos
            </DialogDescription>
          </DialogHeader>

          <ConfiguracaoRegrasNegocio onClose={() => setRegrasModalOpen(false)} />
        </DialogContent>
      </Dialog>
    </DashboardLayout>
  )
