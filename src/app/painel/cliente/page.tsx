          ...
          {carregando ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              <MetricCard
                ...
                value={dados?.metricas.imoveisSalvos || 0}
                subtitle="Imóveis compatíveis"
                icon={<Home className="h-5 w-5" />}
                changeType="increase"
              />
              <MetricCard
                title="Respostas"
                value={dados?.metricas.totalRespostas || 0}
                subtitle="Respostas enviadas"
                icon={<MessageSquare className="h-5 w-5" />}
                changeType="increase"
              />
              <MetricCard
                title="Imóveis Visualizados"
                value={dados?.metricas.imoveisVisualizados || 0}
                subtitle="Total salvos"
