...
export function Topbar({ userRole = "admin", userName = "Admin" }: TopbarProps) {
  ...
  // Verificar se está em rota de cliente para ocultar notificações
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center space-x-2">
        ...
        {/* Dropdown de notificações - Oculto para rotas de cliente */}
        {!isClientRoute && (
            ...
            <DropdownMenuItem 
              onClick={async () => {
                try {
                  ...
                  // Limpar localStorage e sessionStorage para remover qualquer cache
                  localStorage.clear();
                  sessionStorage.clear();
                  
                  // Forçar recarregamento completo da página (limpa cache)
