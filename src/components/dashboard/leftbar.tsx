...
export function LeftBar({ userRole = "admin", userName }: LeftBarProps) {
  ...
  return (
    <TooltipProvider>
    <div 
      className={`fixed left-0 top-16 z-30 h-[calc(100vh-4rem)] ${theme === "dark" ? "bg-zinc-900" : "bg-white"} border-r transition-all duration-300 ease-in-out ${isCollapsed ? "w-[70px]" : "w-[260px]"}`}
